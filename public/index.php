...
if ($estConnecte && $_SESSION['role'] === "comptable") {

    require PATH_VIEWS . 'Comptable/v_entete.php';
} else {
...
if ($estConnecte && $_SESSION['role'] === "comptable") {
    switch ($uc) {
        case 'accueil':
            include PATH_CTRLS . 'Comptable/c_accueil.php';
            break;
        case 'deconnexion':
            include PATH_CTRLS . 'c_deconnexion.php';
            break;
        case 'gererFrais':
            include PATH_CTRLS . 'Comptable/c_gererFrais.php';
            break;
        case 'etatFrais':
            include PATH_CTRLS . 'Comptable/c_SuivreFichedeFrais.php';
